...
from dfi.models.filters import FilterFields, TimeInterval
...
class QueryDocument(dict):
    ...
    def set_dataset_id(self, dataset_id: str) -> None:
        self._internal_document[DATASET_ID] = dataset_id

    def get_dataset_id(self) -> str | None:
        return self._internal_document.get(DATASET_ID)

    def set_time_range(self, time_interval: TimeInterval) -> None:
    ...
    def set_polygon(self, vertices: PolygonOrBBox) -> None:
    ...
    def get_polygon(self) -> PolygonOrBBox | None:
    ...
    def add_filter_fields_from_dict(self, fields_dict: FilterFields) -> None:
